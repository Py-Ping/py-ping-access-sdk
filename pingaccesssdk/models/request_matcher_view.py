...
class RequestMatcherView(Model):
    """A request matcher used to match an unauthenticated request to its challenge response.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, RequestMatcherView):
