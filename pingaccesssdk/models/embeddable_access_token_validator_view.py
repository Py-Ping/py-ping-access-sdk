...
class EmbeddableAccessTokenValidatorView(Model):
    """An Embeddable Access Token Validator configuration.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, EmbeddableAccessTokenValidatorView):
