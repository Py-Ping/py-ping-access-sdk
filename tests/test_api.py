        ...
        api_endpoint = ApiEndpoint('/test/path', [{
            "operations": [
                ...
                },
                {
                    ...
                    "nickname": "doThat", "summary": "does that", "method": "GET"
                },
                {
                    ...
                    "parameters": [
                        {"name": "id", "paramType": "query", "type": "integer", "required": "true"},
                        {"name": "choice", "paramType": "query", "type": "enum", "required": "false"}
                    ],
...
class TestParameter(TestCase):
    def test_param(self):
        test = Parameter({"type": "string", "paramType": "query", "name": "testparameter", "required": "true"})
        self.assertEqual(test.get_parameter_str(), "str")
        self.assertEqual(test.json_type, "string")
        self.assertTrue(test.is_primitive_type)

        test = Parameter({"type": "TestModel", "paramType": "query", "name": "anothertestparameter", "required": "false"})
...
class TestOperation(TestCase):
    def setUp(self):
        self.op_test = Operation(
            parameters=[
                Parameter({"type": "string", "paramType": "query", "name": "one", "required": "true"}),
                Parameter({"type": "TestModel", "paramType": "query", "name": "two", "required": "false"}),
            ],
            response_codes=[
        ...
        self.op_test_none = Operation(
            parameters=[
                Parameter({"type": "bool", "paramType": "query", "name": "three", "required": "true"}),
                Parameter({"type": "array", "paramType": "query", "name": "four", "required": "false"}),
            ],
            response_codes=[
                {"code": 200, "message": "Operation success"},
